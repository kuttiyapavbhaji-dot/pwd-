...
const nameAssignments = ["parth", "parth", "aarav", "shravan", "shravan sachit", "parth", "aarav", "shravan", "aarav", "sachit", "parth", "parth", "sachit", "parth", "parth", "shravan sachit parth", "aarav"];// BANNERS DATA
const phrases = [
  "tinder bakchodi",
